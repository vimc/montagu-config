...
Upgrades to the major version of postgres are disruptive, and will need special work for both packit and for montagu itself.  This is described in [`upgrade-db.md`](upgrade-db.md).
